...
import { IExhibitDto } from "../../types/IExhibitDto";
...
const CreateExhibitSchema = Yup.object().shape({
  description: Yup.string()
    ...
    .max(200, "Description cannot be greater than 200 characters"),
  ...
  const { run: submitForm, loading, error } = useRequest(
    ...
    },
    {
      ...
      onSuccess: () => {
        ...
        successNotification("Post successfully created");
      },
      onError: (err: any) => {
